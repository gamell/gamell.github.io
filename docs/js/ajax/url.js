...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("/",(function (){var fexpr__6093 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name);
return (fexpr__6093.cljs$core$IFn$_invoke$arity$1 ? fexpr__6093.cljs$core$IFn$_invoke$arity$1(key) : fexpr__6093.call(null,key));
})());
} else {
...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__6094){
...
var vec_key_encode = (function (){var G__6098 = (function (){var or__5162__auto__ = vec_strategy;
...
break;
default:
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__6098__$1))));
 ...
 */
ajax.url.param_to_key_value_pairs = (function ajax$url$param_to_key_value_pairs(vec_key_transform,prefix,p__6100){
var vec__6101 = p__6100;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6101,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6101,(1),null);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_key,clojure.string.join.cljs$core$IFn$_invoke$arity$2("/",(function (){var fexpr__6104 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name);
return (fexpr__6104.cljs$core$IFn$_invoke$arity$1 ? fexpr__6104.cljs$core$IFn$_invoke$arity$1(value) : fexpr__6104.call(null,value));
})())], null)], null);
} else {
...
(ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__6107){
var map__6108 = p__6107;
var map__6108__$1 = cljs.core.__destructure_map(map__6108);
var vec_strategy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6108__$1,cljs.core.cst$kw$vec_DASH_strategy);
