...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("/",(function (){var fexpr__6043 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name);
return (fexpr__6043.cljs$core$IFn$_invoke$arity$1 ? fexpr__6043.cljs$core$IFn$_invoke$arity$1(key) : fexpr__6043.call(null,key));
})());
} else {
...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__6044){
var vec__6045 = p__6044;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6045,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6045,(1),null);
...
var vec_key_encode = (function (){var G__6048 = (function (){var or__5162__auto__ = vec_strategy;
...
break;
default:
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__6048__$1))));
 ...
 */
ajax.url.param_to_key_value_pairs = (function ajax$url$param_to_key_value_pairs(vec_key_transform,prefix,p__6050){
var vec__6051 = p__6050;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6051,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6051,(1),null);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new_key,clojure.string.join.cljs$core$IFn$_invoke$arity$2("/",(function (){var fexpr__6054 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name);
return (fexpr__6054.cljs$core$IFn$_invoke$arity$1 ? fexpr__6054.cljs$core$IFn$_invoke$arity$1(value) : fexpr__6054.call(null,value));
})())], null)], null);
} else {
...
(ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__6057){
var map__6058 = p__6057;
var map__6058__$1 = cljs.core.__destructure_map(map__6058);
var vec_strategy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6058__$1,cljs.core.cst$kw$vec_DASH_strategy);
