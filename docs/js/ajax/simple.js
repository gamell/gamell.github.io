...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__6468){
var map__6469 = p__6468;
var map__6469__$1 = cljs.core.__destructure_map(map__6469);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6469__$1,cljs.core.cst$kw$handler);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(request,cljs.core.cst$kw$method,ajax.simple.normalize_method),cljs.core.cst$kw$interceptors,(function (p1__6470_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__5162__auto__ = p1__6470_SHARP_;
 ...
 */
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__6471){
var map__6472 = p__6471;
var map__6472__$1 = cljs.core.__destructure_map(map__6472);
var request = map__6472__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6472__$1,cljs.core.cst$kw$interceptors);
...
var api = (function (){var or__5162__auto__ = cljs.core.cst$kw$api.cljs$core$IFn$_invoke$arity$1(request__$1);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
