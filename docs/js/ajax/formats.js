...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__7011){
...
var request = map__7012__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7012__$1,cljs.core.cst$kw$response_DASH_format);
...
var fexpr__7016 = cljs.core.cst$kw$read.cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__7016.cljs$core$IFn$_invoke$arity$1 ? fexpr__7016.cljs$core$IFn$_invoke$arity$1(response) : fexpr__7016.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__7017 = cljs.core.cst$kw$read.cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__7017.cljs$core$IFn$_invoke$arity$1 ? fexpr__7017.cljs$core$IFn$_invoke$arity$1(response) : fexpr__7017.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__7019){
var map__7020 = p__7019;
...
var request = map__7020__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7020__$1,cljs.core.cst$kw$response_DASH_format);
