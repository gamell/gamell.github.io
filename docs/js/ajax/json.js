...
var ajax$json$make_json_response_format_$_json_response_format__1 = (function (p__6453){
var map__6454 = p__6453;
var map__6454__$1 = cljs.core.__destructure_map(map__6454);
var prefix = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6454__$1,cljs.core.cst$kw$prefix);
var keywords_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6454__$1,cljs.core.cst$kw$keywords_QMARK_);
var raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6454__$1,cljs.core.cst$kw$raw);
...
var G__6455 = raw;
var G__6456 = keywords_QMARK_;
var G__6457 = ajax.json.strip_prefix(prefix,ajax.protocols._body(xhrio));
return (read_json.cljs$core$IFn$_invoke$arity$3 ? read_json.cljs$core$IFn$_invoke$arity$3(G__6455,G__6456,G__6457) : read_json.call(null,G__6455,G__6456,G__6457));
}),cljs.core.cst$kw$description,(""+"JSON"+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(prefix)?(""+" prefix '"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(prefix)+"'"):null))+cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(keywords_QMARK_)?" keywordize":null))),cljs.core.cst$kw$content_DASH_type,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["application/json"], null)], null));
});
ajax$json$make_json_response_format_$_json_response_format = function(p__6453){
switch(arguments.length){
case 0:
return ajax$json$make_json_response_format_$_json_response_format__0.call(this);
case 1:
return ajax$json$make_json_response_format_$_json_response_format__1.call(this,p__6453);
}
