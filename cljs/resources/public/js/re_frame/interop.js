...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__30416 = cljs.core.instance_QMARK_;
var expr__30417 = reactive_val;
if(cljs.core.truth_(pred__30416.call(null,reagent.ratom.RAtom,expr__30417))){
return "ra";
} else {
if(cljs.core.truth_(pred__30416.call(null,reagent.ratom.RCursor,expr__30417))){
return "rc";
} else {
if(cljs.core.truth_(pred__30416.call(null,reagent.ratom.Reaction,expr__30417))){
return "rx";
} else {
if(cljs.core.truth_(pred__30416.call(null,reagent.ratom.Track,expr__30417))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1504274998849
