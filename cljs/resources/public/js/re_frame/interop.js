...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__9835 = cljs.core.instance_QMARK_;
var expr__9836 = reactive_val;
if(cljs.core.truth_(pred__9835.call(null,reagent.ratom.RAtom,expr__9836))){
return "ra";
} else {
if(cljs.core.truth_(pred__9835.call(null,reagent.ratom.RCursor,expr__9836))){
return "rc";
} else {
if(cljs.core.truth_(pred__9835.call(null,reagent.ratom.Reaction,expr__9836))){
return "rx";
} else {
if(cljs.core.truth_(pred__9835.call(null,reagent.ratom.Track,expr__9836))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1504247914697
