...
var vec__10542_10545 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_10546 = cljs.core.nth.call(null,vec__10542_10545,(0),null);
var only_after_10547 = cljs.core.nth.call(null,vec__10542_10545,(1),null);
var db_changed_QMARK__10548 = (!((only_before_10546 == null))) || (!((only_after_10547 == null)));
if(db_changed_QMARK__10548){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_10546);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_10547);
...
var map__10549 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__10549__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__10549__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__10551 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__10551__$1;
var event = cljs.core.get.call(null,map__10551__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__8814__auto___10554 = arguments.length;
var i__8815__auto___10555 = (0);
while(true){
if((i__8815__auto___10555 < len__8814__auto___10554)){
args__8821__auto__.push((arguments[i__8815__auto___10555]));

var G__10556 = (i__8815__auto___10555 + (1));
i__8815__auto___10555 = G__10556;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq10553){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10553));
});
...
var args__8821__auto__ = [];
var len__8814__auto___10562 = arguments.length;
var i__8815__auto___10563 = (0);
while(true){
if((i__8815__auto___10563 < len__8814__auto___10562)){
args__8821__auto__.push((arguments[i__8815__auto___10563]));

var G__10564 = (i__8815__auto___10563 + (1));
i__8815__auto___10563 = G__10564;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__10557_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__10558_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__10558_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq10559){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__10560,G__10561,seq10559__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1504247915998
