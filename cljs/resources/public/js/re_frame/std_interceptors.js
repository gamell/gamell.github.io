...
var vec__31229_31232 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_31233 = cljs.core.nth.call(null,vec__31229_31232,(0),null);
var only_after_31234 = cljs.core.nth.call(null,vec__31229_31232,(1),null);
var db_changed_QMARK__31235 = (!((only_before_31233 == null))) || (!((only_after_31234 == null)));
if(db_changed_QMARK__31235){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_31233);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_31234);
...
var map__31236 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__31236__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__31236__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__31238 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__31238__$1;
var event = cljs.core.get.call(null,map__31238__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__29455__auto___31241 = arguments.length;
var i__29456__auto___31242 = (0);
while(true){
if((i__29456__auto___31242 < len__29455__auto___31241)){
args__29462__auto__.push((arguments[i__29456__auto___31242]));

var G__31243 = (i__29456__auto___31242 + (1));
i__29456__auto___31242 = G__31243;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq31240){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31240));
});
...
var args__29462__auto__ = [];
var len__29455__auto___31249 = arguments.length;
var i__29456__auto___31250 = (0);
while(true){
if((i__29456__auto___31250 < len__29455__auto___31249)){
args__29462__auto__.push((arguments[i__29456__auto___31250]));

var G__31251 = (i__29456__auto___31250 + (1));
i__29456__auto___31250 = G__31251;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__31244_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__31245_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__31245_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq31246){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__31247,G__31248,seq31246__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1504275001855
