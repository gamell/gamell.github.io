...
var G__30268 = o;
(G__30268[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__30270__i < G__30270__a.length) {G__30270__a[G__30270__i] = arguments[G__30270__i + 0]; ++G__30270__i;}
  args = new cljs.core.IndexedSeq(G__30270__a,0,null);
} 
...
var args = cljs.core.seq(arglist__30271);
...
var G__30274 = jsprops;
(G__30274["defaultValue"] = value);

(G__30274["onChange"] = ((function (G__30274,v,value,on_change){
return (function (p1__30273_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__30273_SHARP_);
});})(G__30274,v,value,on_change))
);
...
var vec__30277 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__30277,(0),null);
var id = cljs.core.nth.call(null,vec__30277,(1),null);
var class$ = cljs.core.nth.call(null,vec__30277,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___30281 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___30281 == null)){
} else {
var key_30282 = temp__4661__auto___30281;
(jsprops["key"] = key_30282);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__30283 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__30283["name"] = c);
...
var len__29455__auto___30288 = arguments.length;
var i__29456__auto___30289 = (0);
while(true){
if((i__29456__auto___30289 < len__29455__auto___30288)){
args__29462__auto__.push((arguments[i__29456__auto___30289]));

var G__30290 = (i__29456__auto___30289 + (1));
i__29456__auto___30289 = G__30290;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq30286){
var G__30287 = cljs.core.first.call(null,seq30286);
var seq30286__$1 = cljs.core.next.call(null,seq30286);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__30287,seq30286__$1);
});
...
break;
default:
var G__30293 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__30293;
continue;
...
var n__29231__auto___30295 = a.length;
var i_30296 = (0);
while(true){
if((i_30296 < n__29231__auto___30295)){
(a[i_30296] = reagent.impl.template.as_element.call(null,(a[i_30296])));

var G__30297 = (i_30296 + (1));
i_30296 = G__30297;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__29231__auto___30298 = a.length;
var i_30299 = (0);
while(true){
if((i_30299 < n__29231__auto___30298)){
var val_30300 = (a[i_30299]);
if((cljs.core.vector_QMARK_.call(null,val_30300)) && ((reagent.impl.template.key_from_vec.call(null,val_30300) == null))){
(o["no-key"] = true);
} else {
}

(a[i_30299] = reagent.impl.template.as_element.call(null,val_30300));

var G__30301 = (i_30299 + (1));
i_30299 = G__30301;
continue;
} else {
}
...
var ctx = ({});
var vec__30302 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__30302,(0),null);
var derefed = cljs.core.nth.call(null,vec__30302,(1),null);
...
var G__30305 = (cljs.core.count.call(null,argv) - first_child);
switch (G__30305) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__30305){
...
//# sourceMappingURL=template.js.map?rel=1504274998517
